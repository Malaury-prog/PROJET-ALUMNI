...
- [x] Page 404
- [x] Page Annuaire (grille + filtres)
- [ ] Page Profil apprenant
- [ ] Dashboard Admin
- [ ] Back-end PHP (API REST + PDO MySQL)
- [x] Compléter la table `utilisateurs` (colonnes manquantes : description, titre_poste, linkedin_url, github_url, telephone, entreprise_nom)
...
Certification délivré suite au passage. 
