...
const Hero = () => {
  return (
    <section
      className="relative w-full h-hero flex items-center justify-center"
      style={{
    ...
    >
      ...
      <div className="relative z-10 text-center max-w-7xl mx-auto px-3w">
        <h1 className="text-h1 font-weight-bold text-white font-marianne">
